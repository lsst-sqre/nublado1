...
c.SQREKubeSpawner.http_timeout = 60 * 5
...
#c.Spawner.cmd = 'jupyterhub-singleuser'
#c.Spawner.default_url = '/lab'
#c.Spawner.args = ['lab --debug']
#c.SQREKubeSpawner.cmd = '/opt/lsst/software/jupyterlab/lablauncher.sh'
#c.SQREKubeSpawner.args = []
c.SQREKubeSpawner.default_url = '/lab'
#c.SQREKubeSpawner.args = ['lab --debug']
#c.KubeSpawner.cmd = 'jupyter'
#c.KubeSpawner.default_url = '/lab'
#c.KubeSpawner.args = ['lab', '--debug', '--port=8888', '--ip=*']
